...
if (isset($_POST['norserune_process']) && $_POST['norserune_process'] == 'y') {
	...
	$updates = "Norse Rune Oracle Plugin Settings Updated.";
}

	runes_header();
	$definitions_page = get_option( 'norserune_definitionpage' );
	echo "<h2>Norse Rune Oracle Instructions/Setup</h2>";
...
<li>To display the Past Present Future (Three Rune Layout) Form you use the shortcode <strong>[threerune]</strong>.</li>
<li>To display the Expanded Celtic Cross (Twelve Rune Layout) Spread Form you use the shortcode <strong>[celticcross]</strong>.</li>
<li>To display the make your own srpread use the shortcode <strong>[norsecustom]</strong>. This puts a form on a page and asks how many runes you would like to show.</li>
</ul></li>
